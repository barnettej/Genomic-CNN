...
x = input
x = layers.Dense(units=71)(x)
x = layers.Dropout(0.051302)(x)
x = layers.Dense(units=52)(x)
x = layers.Dropout(0.1891)(x)
...
np.savetxt("test.geno_pred_pc.pc_to_pheno.csv", predictions[2],  delimiter=",")
